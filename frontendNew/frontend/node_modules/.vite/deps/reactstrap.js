...
function getChildMapping(children2, mapFn) {
  ...
  if (children2) import_react26.Children.map(children2, function(c) {
    return c;
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react28.default.Children.count(props[propName]) !== 2) return new Error('"' + propName + '" must be exactly two transition components.');
    return null;
  }
} : {};
...
function UncontrolledAccordion(_ref) {
  ...
  return import_react33.default.createElement(Accordion_default, _extends26({}, _objectSpread8({
    tag: "div"
  }, props), {
    open,
    toggle: toggle2
...
function Tooltip(props) {
  ...
  return import_react71.default.createElement(TooltipPopoverWrapper_default, _extends61({}, _props, {
    arrowClassName: arrowClasses,
    popperClassName: popperClasses,
    innerClassName: classes
  }));
