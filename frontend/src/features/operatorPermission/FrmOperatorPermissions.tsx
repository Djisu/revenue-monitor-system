...
//   createOperatorPermission, 
//   updateOperatorPermission, 
//   deleteOperatorPermission, OperatorPermissionState } from './operatorPermissionSlice';

// import { fetchOperators } from '../operatorDefinition/operatorDefinitionSlice';

// interface OperatorPermissionData {
//   operatorid: string;  // Change to lowercase
//   menus: string;       // Change to lowercase
//   Reports?: string;
//   databasesx?: string;
//   password?: string;
//   message?: string;
...
//   //let [operatorPermissions, setOperatorPermissions] = useState<OperatorPermissionData[]>([]);
//   const [error, setError] = useState<string>('');
//   const [successMessage, setSuccessMessage] = useState<string>('');
//   let [operatorList, setOperatorList] = useState<OperatorPermissionState[]>([]);

//   // Local state to hold operator permission 
//   const [localOperatorPermissions, setLocalOperatorPermissions] = useState<OperatorPermissionData[]>([]);
...
//  // let {operatorPermissions} : OperatorPermissionData = operatorPermissionsValues;
...
// useEffect(() => {
//   if (operatorPermissionsValues.operatorPermissions) {
//       setLocalOperatorPermissions(operatorPermissionsValues.operatorPermissions); // Adjust this line
//   }
// }, [operatorPermissionsValues]); // Dependency array includes operatorPermissions

// console.log('Local operatorPermissions: ', localOperatorPermissions);

// useEffect(() => {
//   console.log('Updated localOperatorPermissions:', localOperatorPermissions);
// }, [localOperatorPermissions]);

//   useEffect(() => {
//     fetchOperatorList();
//     fetchOperatorPermissions(dispatch);
//   }, [dispatch]);
...
//   const fetchOperatorPermissions = async (dispatch: any) => {
//     try {
//         const response = await dispatch(fetchOperatorPermissionsThunk());
//         console.log('response: ', response);

//         if (response.payload.length > 0) {
//           const permissionsData = response.payload[0].data; // Extract data
//           console.log('Permissions Data:', permissionsData); // Log the extracted data
//           setLocalOperatorPermissions(permissionsData as OperatorPermissionData[]); // Set the state

//           console.log('Type of permissionsData:', typeof permissionsData);
//           console.log('Object keys:', Object.keys(permissionsData[0])); // Log keys of the first object   
//         } else {
//             setLocalOperatorPermissions([]); // Handle case where no data
//         }
//     } catch (error) {
//         console.error(error);
//         setError('Error fetching operator permissions');
...
//   // return (
//   //   <div>
//   //       <h3>Local Operator Permissions:</h3>
//   //       <pre>{JSON.stringify(localOperatorPermissions, null, 2)}</pre>
//   //   </div>
//   // );
...
//                 localOperatorPermissions.map((permission, index) => (
//                     <tr key={index}>
//                         <td>{permission.operatorid}</td>  {/* Correct access */}
//                         <td>{permission.menus}</td>       {/* Correct access */}
//                     </tr>
//                 ))
//             ) : (
//                 <tr>
