...
//   const [cboOfficerNo, setCboOfficerNo] = useState('');
//   const [cboBusNo, setCboBusNo] = useState('');
//   const [txtAmount, setTxtAmount] = useState(0);
//   const [cboPaymentMonth, setCboPaymentMonth] = useState('');
//   const [txtReceiptNo, setTxtReceiptNo] = useState('0');
//   const [lblBusname, setLblBusname] = useState('');
//   const [lblBusinessType, setLblBusinessType] = useState('');
//   const [lblRate, setLblRate] = useState(0);
//   const [lblBalanceBF, setLblBalanceBF] = useState(0);
//   // @ts-ignore
...
//   const [lstView1Items, setListView1Items] = useState<any[]>([]);
//   const [lstView3Items, setListView3Items] = useState<any[]>([]);

//    // @ts-ignore
//   let [dtTransDate, setDtTransDate] = useState(new Date());

//   const [txtOwner, setTxtOwner] = useState('');
//   setMDImain(null)
