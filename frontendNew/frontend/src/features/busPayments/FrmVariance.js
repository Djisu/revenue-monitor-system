...
var VarianceAnalysis = function () {
    ...
    var _f = useState([]), businessTypes = _f[0], setBusinessTypes = _f[1];
    var _g = useState([]), electoralAreas = _g[0], setElectoralAreas = _g[1];
    ...
    var fetchDates = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch('/api/dates')];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // Reset error message
                    setError('');
                    return [4 /*yield*/, fetch("/api/detailedPreview?business_type=".concat(businessType, "&electoral_area=").concat(electoralArea, "&start_date=").concat(startDate, "&end_date=").concat(endDate))];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // Reset error message
                    setError('');
                    return [4 /*yield*/, fetch("/api/summaryPreview?business_type=".concat(businessType, "&electoral_area=").concat(electoralArea, "&start_date=").concat(startDate, "&end_date=").concat(endDate))];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
