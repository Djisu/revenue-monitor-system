...
var FrmPropertyCollectorElectoralArea = function () {
    ...
    return (_jsxs(Container, { children: [_jsx(Row, { className: "mt-4", children: _jsx(Col, { children: _jsxs(Card, { children: [_jsx(Card.Header, { as: "h5", className: "text-center bg-primary text-white", children: "MARCORY MUNICIPAL ASSEMBLY" }), _jsx(Card.Body, { children: _jsxs(Form, { children: [_jsxs(Form.Group, { controlId: "formOfficerNo", children: [_jsx(Form.Label, { children: "Collector:" }), _jsxs(Form.Control, { as: "select", value: officerNo, onChange: function (e) { return setOfficerNo(e.target.value); }, children: [_jsx("option", { value: "", children: "Select Officer No" }), officerNos.map(function (no) { return (_jsx("option", { value: no, children: no }, no)); })] })] }), _jsxs(Form.Group, { controlId: "formElectoralArea", children: [_jsx(Form.Label, { children: "Suburb:" }), _jsxs(Form.Control, { as: "select", value: electoralArea, onChange: function (e) { return setElectoralArea(e.target.value); }, children: [_jsx("option", { value: "", children: "Select Electoral Area" }), electoralAreas.map(function (area) { return (_jsx("option", { value: area, children: area }, area)); })] })] }), _jsx(Button, { variant: "primary", onClick: handleAddRecord, children: "Add New Record" })] }) })] }) }) }), _jsx(Row, { className: "mt-4", children: _jsx(Col, { children: _jsxs(Card, { children: [_jsx(Card.Header, { as: "h5", className: "bg-primary text-white", children: "List of Collectors And Their Layouts" }), _jsx(Card.Body, { children: _jsxs(Table, { striped: true, bordered: true, hover: true, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "OFFICER NO" }), _jsx("th", { children: "OFFICER NAME" }), _jsx("th", { children: "ELECTORAL AREA" }), _jsx("th", { children: "ACTION" })] }) }), _jsx("tbody", { children: collectors.map(function (collector, index) { return (_jsxs("tr", { children: [_jsx("td", { children: collector.officerNo }), _jsx("td", { children: collector.officerName }), _jsx("td", { children: collector.electoralArea }), _jsx("td", { children: _jsx(Button, { variant: "danger", onClick: function () { return handleDeleteRecord(index); }, children: "Delete" }) })] }, index)); }) })] }) })] }) }) }), _jsx(Row, { className: "mt-4", children: _jsx(Col, { children: _jsxs(Card, { children: [_jsx(Card.Header, { as: "h5", className: "bg-primary text-white", children: "Activity" }), _jsx(Card.Body, { children: _jsx(Button, { variant: "secondary", onClick: function () { return alert('Exit clicked'); }, children: "Exit" }) })] }) }) }), _jsx(Row, { className: "mt-3", children: _jsx(Col, { children: _jsx(Link, { to: "/main", className: "primary m-3", children: "Go Back" }) }) })] }));
};
