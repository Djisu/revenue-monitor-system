...
// }
var FrmDailyPropertyPayments = function () {
    var _a = useState(''), cboZone = _a[0], setCboZone = _a[1];
    var _b = useState(''), cboBussType = _b[0], setCboBussType = _b[1];
    var _c = useState(''), cboFirstDate = _c[0], setCboFirstDate = _c[1];
    var _d = useState(''), cboLastDate = _d[0], setCboLastDate = _d[1];
    var _e = useState([]), zoneOptions = _e[0], setZoneOptions = _e[1];
    var _f = useState([]), bussTypeOptions = _f[0], setBussTypeOptions = _f[1];
    var _g = useState([]), firstDateOptions = _g[0], setFirstDateOptions = _g[1];
    var _h = useState([]), lastDateOptions = _h[0], setLastDateOptions = _h[1];
    var _j = useState([]), lstViewItems = _j[0], setListViewItems = _j[1];
    useEffect(function () {
        setListViewItems([]);
